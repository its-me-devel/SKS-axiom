...
<svelte:head>
	<title>SKS Axiom — We Build. Secure. Deploy. Scale.</title>
	<meta
		name="description"
	...
	<meta
		...
		content="Full-stack web development, security-first engineering and AWS cloud infrastructure, delivered by one accountable team."
	/>
